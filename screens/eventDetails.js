...
export default class EventDetails extends React.Component{
    ...
    addCancelNotification = ()=>{
        ...
        var list = db.collection('participants').where('eventId', '==', this.state.eventId)
        list.where('participant', '==', this.state.userId)
    }
    ReallyCancel = ()=>{
        ...
        console.log(this.state.id, 'is the id')
        db.collection('invites').doc(this.state.id).delete()
    }
    componentDidMount(){
